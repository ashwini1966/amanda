...
<footer id="page-footer" class="bg-body-light">
        <div class="content py-0">
          <div class="row fs-sm">
            ...
            <div class="col-sm-6 order-sm-1 text-center text-sm-start">
              <a class="fw-semibold" href="https://1.envato.market/r6y" target="_blank"> Unspoken Language Services</a> &copy; <span data-toggle="year-copy"></span>
            </div>
          </div>
        </div>
      </footer>
    ...
    <!-- END Page Container -->
    <script src="<?php echo base_url('assets/js/dashmix.app.min.js') ?>"></script>
    ...
    <script src="<?php echo base_url('assets/js/plugins/datatables-buttons-bs5/js/buttons.bootstrap5.min.js') ?>"></script>
    <!-- Page JS Code -->
    <script src=" <?php echo base_url('assets/js/pages/be_tables_datatables.min.js') ?>"></script>

    <script src="<?php echo base_url('assets/js/plugins/fullcalendar/main.min.js') ?>"></script>
    ...
    <script src="<?php echo base_url('assets/js/plugins/dropzone/min/dropzone.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/js/plugins/pwstrength-bootstrap/pwstrength-bootstrap.min.js') ?>"></script>
